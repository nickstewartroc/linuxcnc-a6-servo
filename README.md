...
This component requires an understanding of linuxcnc internals. It is complicated because it deals with all joints at one time. First, lets decide on the pins we need which are added to the joints
   ...
   - **joint.n.custom_homing_finished** <-- Not needed in the example
...
This component can be built using halcompile but it requires the source code of **homing.c** to exist on your computer. The location of this file must be set in the source code. You might also need to update the two include file locations
```
#define HOMING_BASE home/rod/linuxcnc-dev/src/emc/motion/homing.c
#include "/home/linuxcnc/Desktop/linuxcnc-source-dir/src/emc/motion/motion.h"
#include "/home/linuxcnc/Desktop/linuxcnc-source-dir/src/emc/motion/homing.h"
```
